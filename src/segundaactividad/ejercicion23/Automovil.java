...
public class Automovil {
    ...
    void acelerar (int incrementoVelocidad){
        if (velocidadActual + incrementoVelocidad < velocidadMaxima){
            ...
            System.out.println("No se puede incrementar a una velocidad superior"
                    + "a la maxima de automovil.");
        }
    }
    ...
    void desacelerar (int decrementoVelocidad){
        if (velocidadActual - decrementoVelocidad > 0){
            ...
            System.out.println("No se puede incrementar a una velocidad negativa");
        }
    }
